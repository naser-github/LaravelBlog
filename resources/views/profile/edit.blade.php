    ...
    <div class="container">
        ...
        @csrf
            ...
            <div class="mb-3 col-10">
                ...
                <input type="phone" name="phone" class="form-control" id="phone" aria-describedby="phone" value="{{$profile->phone}}">
            </div>

            <div class="mb-3 col-10">
                <label for="dob" class="form-label">Date of Birth</label>
                <input type="date" name="dob" class="form-control" id="dob" aria-describedby="dob" value="{{$profile->profile_dob}}">
            </div>

            <div class="mb-3 col-10">
                <label for="address" class="form-label">Address</label>
                <input type="text" name="address" class="form-control" id="address" aria-describedby="address" value="{{$profile->profile_address}}">
            </div>

            <div class="mb-3 col-10">
                <label for="bio" class="form-label">Profile Bio</label>
                <input type="text" name="bio" class="form-control" id="bio" aria-describedby="bio" value="{{$profile->profile_bio}}">
            </div>
